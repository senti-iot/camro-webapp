				...
				{emissionStats &&
					<Grid container alignItems="center" className={classes.graphRibbonGrid}>
						<Grid item xs={3} style={{ textAlign: 'center' }}>
							<Typography style={{ fontSize: '1.1rem', color: '#fff' }}>
						...
						<Grid item xs={3} style={{ textAlign: 'center' }}>
							<Typography style={{ fontSize: '1.1rem', color: '#fff' }}>
							Udvikling <span style={{ fontSize: '1.1rem', color: (emissionStats.reduction > 0 ? '#C60018' : '#B3DC10') }}><NumberFormat value={emissionStats.reduction} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} decimalScale={1} />%</span> {emissionStats.reduction > 0 ? <ArrowUp style={{ width: 14, paddingTop: 2 }} /> : <ArrowDown style={{ width: 14, paddingTop: 2 }} />}
							</Typography>
						</Grid>
						<Grid item xs={3} style={{ textAlign: 'center' }}>
							<Typography style={{ fontSize: '1.1rem', color: '#fff' }}>
